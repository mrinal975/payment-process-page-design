...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background-color: #C5D6F0; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
            <div style=" border-radius: 5px; margin-top: 20px;">
                <div style="text-align: center; margin-bottom: 20px; border-bottom: 3px solid #C1D2F4;">
                    <img src={{ asset('assets/img/master-card.png') }} alt="Mastercard Logo" style="height: 80px;">
            ...
            <div style="padding: 20px; border-radius: 5px; margin-top: 20px;">
                <p style="font-size: 14px; color: #4a4a4a; text-align: center;">
                ...
                <p style="font-size: 14px; color: #4a4a4a; text-align: center;">
                    If you have any questions or concerns, contact us. We're available to help.
                </p>
                <p style="font-size: 14px; color: #4a4a4a; text-align: center;">
                    The ID Theft Protection Team
                </p>
            </div>
        </div>
    </div>
